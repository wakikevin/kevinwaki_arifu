...
--
-- Host: localhost    Database: arifu_db
-- ------------------------------------------------------
...
INSERT INTO `tbl_subjects` VALUES (1,'Kiswahili','Test Subject','2016-09-30','2016-09-30');
/*!40000 ALTER TABLE `tbl_subjects` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tbl_user_subjects`
--

DROP TABLE IF EXISTS `tbl_user_subjects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `tbl_user_subjects`
--

LOCK TABLES `tbl_user_subjects` WRITE;
/*!40000 ALTER TABLE `tbl_user_subjects` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_user_subjects` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-09-30 17:13:46
